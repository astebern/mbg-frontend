            ...
            <div className="bg-surface-bright p-10 rounded-[24px] space-y-10 shadow-sm border border-outline">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-surface p-1.5 rounded-xl flex gap-1 border border-outline">
                  <button className="flex-1 py-3 px-6 rounded-lg bg-surface-bright text-primary font-bold shadow-sm transition-all flex items-center justify-center gap-2 border border-outline">
                    <Soup className="w-5 h-5" />
                    Cook at Home
                  </button>
                  <button className="flex-1 py-3 px-6 rounded-lg text-on-surface-variant font-medium hover:bg-surface-dim transition-all flex items-center justify-center gap-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <select className="w-full appearance-none bg-surface border border-outline rounded-xl py-4 pl-12 pr-4 text-on-surface focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer font-semibold">
                      <option>London, Kensington</option>
                      <option>New York, Brooklyn</option>
                      <option>Paris, Le Marais</option>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <span className="px-4 py-2 bg-secondary-fixed text-on-secondary-fixed rounded-full text-[11px] font-bold flex items-center gap-2">
            ...
            <div className="bg-surface-bright border border-outline rounded-[24px] overflow-hidden group shadow-sm">
              <div className="h-64 bg-surface relative overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full w-fit border border-outline">
                    ...
                    <span className="text-[10px] font-bold text-on-surface uppercase tracking-wider">Kensington Radius: 2.5mi</span>
                  </div>
                </div>
              </div>
              <div className="p-8 space-y-4">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Kensington offers 14 artisan grocers and 82 curated dining options within your current 45-minute travel threshold.
                </p>
